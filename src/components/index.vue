<template>
  ...
  <el-col :span="19"><h2 class="title">电商后台管理页面</h2></el-col>
  <el-col :span="1"><a href="#" class="logout">退出</a></el-col>
</el-row>
    </el-header>
    <el-container>
      <el-aside width="200px" class="my_aside">
         <el-menu default-active="5" class="el-menu-vertical-demo" @open="handleOpen" @close="handleClose" :collapse="isCollapse" :unique-opened="true">
           <!-- 左侧导航 -->
  <el-submenu index="1">
    <template slot="title">
